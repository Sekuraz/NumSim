...
\begin{frame}{Mehrgitter Methode (MG)}
  ...
  \begin{align*}
    ...
    \frac{\partial p}{\partial n} &= rhs + res \\
    \frac{\partial e^c}{\partial n} &= res^c = R_\Gamma\ res
  \end{align*}
  \end{minipage}
  \pause
  \begin{minipage}{0.49\linewidth}
  ...
  \begin{tikzpicture}[scale=1.0]
	...
	\draw[red] (1.0, 1.0) node[above, xshift=-0.25cm, yshift=-0.05cm] {\scriptsize $e^c_{0,j}$};
    \draw[red] (3.0, 1.0) node[above, xshift=-0.25cm, yshift=-0.05cm] {\scriptsize $e^c_{1,j}$};
...
\begin{frame}{Konjugierte Gradienten Methode (CG)}
  \begin{itemize}[<+(1)->]
    ...
    \item Optimierung des Algorithmus liefert als wesentlichen Aufwand eine
        Matrix-Vektor-Multiplikation und zwei Skalarprodukte pro Iteration
  \end{itemize}
\end{frame}
  ...
  \begin{itemize}[<+(1)->]
    ...
    \only<5>{
      \tikz[overlay, remember picture] {
        ...
        \node [below right] at (picture) {\includegraphics[scale=0.46]{quadtree_octree_netzverfeinerung_kante.png}};
        \node [xshift=3.6cm, yshift=-3.6cm] at (picture) {\href{http://me-lrt.de/v4-6-implementierung-finite-elemente}{\tiny Quelle: http://me-lrt.de/v4-6-implementierung-finite-elemente}};
      }%
    }
    \item Full Multigrid und Full Approximation Scheme (Nichtlineare Probleme)
    \only<6>{
      \tikz[overlay, remember picture] {
        \coordinate (picture) at ($(current page.south west)+(6.9cm,8cm)$);
        \node [below right] at (picture) {

          \begin{tikzpicture}[scale=0.44]
            \draw [<->,thick, >=latex] (0,6) node (yaxis) [above] {} |- (18,0) node (xaxis) [right] {};

            \draw[black] (-0.1,1) -- (0.1,1);
            \draw[black] (0,1) node [left] {$16h$};

            \draw[black] (-0.1,2) -- (0.1,2);
            \draw[black] (0,2) node [left] {$8h$};

            \draw[black] (-0.1,3) -- (0.1,3);
            \draw[black] (0,3) node [left] {$4h$};

            \draw[black] (-0.1,4) -- (0.1,4);
            \draw[black] (0,4) node [left] {$2h$};

            \draw[black] (-0.1,5) -- (0.1,5);
            \draw[black] (0,5) node [left] {$h$};

            \draw[red, fill] (1,1) circle [radius=0.1] node (1) {};
            \draw[red, fill] (2,2) circle [radius=0.1] node (2) {};
            \draw[->,>=latex, double] (1.1,1.1) -- (1.9,1.9);

            \draw[red, fill] (3,1) circle [radius=0.1] node (3) {};
            \draw[->,>=latex, blue] (2.1,1.9) -- (2.9,1.1);

            \draw[red, fill] (4,2) circle [radius=0.1] node (4) {};
            \draw[->,>=latex] (3.1,1.1) -- (3.9,1.9);

            \draw[red, fill] (5,3) circle [radius=0.1] node (5) {};
            \draw[->,>=latex, double] (4.1,2.1) -- (4.9,2.9);

            \draw[red, fill] (6,2) circle [radius=0.1] node (6) {};
            \draw[->,>=latex, blue] (5.1,2.9) -- (5.9,2.1);

            \draw[red, fill] (7,1) circle [radius=0.1] node (7) {};
            \draw[->,>=latex, blue] (6.1,1.9) -- (6.9,1.1);

            \draw[red, fill] (8,2) circle [radius=0.1] node (8) {};
            \draw[->,>=latex] (7.1,1.1) -- (7.9,1.9);

            \draw[red, fill] (9,3) circle [radius=0.1] node (9) {};
            \draw[->,>=latex] (8.1,2.1) -- (8.9,2.9);

            \draw[red, fill] (10,4) circle [radius=0.1] node (10) {};
            \draw[->,>=latex, double] (9.1,3.1) -- (9.9,3.9);

            \draw[red, fill] (11,3) circle [radius=0.1] node (11) {};
            \draw[->,>=latex, blue] (10.1,3.9) -- (10.9,3.1);

            \draw[red, fill] (12,2) circle [radius=0.1] node (12) {};
            \draw[->,>=latex, blue] (11.1,2.9) -- (11.9,2.1);

            \draw[red, fill] (13,1) circle [radius=0.1] node (13) {};
            \draw[->,>=latex, blue] (12.1,1.9) -- (12.9,1.1);

            \draw[red, fill] (14,2) circle [radius=0.1] node (8) {};
            \draw[->,>=latex] (13.1,1.1) -- (13.9,1.9);

            \draw[red, fill] (15,3) circle [radius=0.1] node (9) {};
            \draw[->,>=latex] (14.1,2.1) -- (14.9,2.9);

            \draw[red, fill] (16,4) circle [radius=0.1] node (9) {};
            \draw[->,>=latex] (15.1,3.1) -- (15.9,3.9);

            \draw[red, fill] (17,5) circle [radius=0.1] node (10) {};
            \draw[->,>=latex, double] (16.1,4.1) -- (16.9,4.9);

            \draw[->,>=latex, double] (1, 6) -- (2,6) node[right] {\textcolor{black}{\scriptsize Interpolation}};
            \draw[->,>=latex] (1, 5) -- (2,5) node[right] {\textcolor{black}{\scriptsize Prolongation}};
            \draw[->,>=latex, blue] (1, 4) -- (2,4) node[right] {\textcolor{black}{\scriptsize Restriktion}};
