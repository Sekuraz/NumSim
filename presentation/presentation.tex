  ...
  \begin{itemize}[<+(1)->]
    ...
    \only<5>{
      \tikz[overlay, remember picture] {
        ...
        \node [below right] at (picture) {\includegraphics[scale=0.5]{quadtree_octree_netzverfeinerung_kante.png}};
      }%
    }
    ...
    \only<6>{
      \tikz[overlay, remember picture] {
        \coordinate (picture) at ($(current page.south west)+(8cm,8cm)$);
        \node [below right] at (picture) {\includegraphics[scale=0.3]{FullMGCycle.png}};
      }%
    }
