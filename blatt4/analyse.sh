...
awk -f mc_mean-sd.awk Montecarlo*/run{1..500}.log > mc_mean-sd_2000.csv
...
awk -f tr_mean-sd.awk Trapez*/run{0..200}.log > tr_mean-sd_200.csv
...
tail -qn 1 Trapez*/run{0..200}.log | awk -f tr_conv.awk > tr_conv.csv
echo 'TR: conv done'
